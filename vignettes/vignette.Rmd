...
case_file <- "D:/Users/Duong/Documents/sobekio/tmp/cases.txt"
...
```{r}
his_results <- his_from_case(case.list = case_list,
                          sobek.project = so_prj,
                          qID = qid_list,
                          wID = wid_file)
head(his_results$waterlevel)
head(his_results$discharge)
```
