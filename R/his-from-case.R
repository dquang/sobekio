...
#' ID_TYPE is one of wID, qID, mID, lID (latID), sID
...
his_from_case<- function(
  ...
  id_types <- c('MID', 'WID', 'QID', 'LID', 'LATID', 'SID')
  id_type <- toupper(names(f_args$...))
  stopifnot(id_type %in% id_types)
  id_list <- eval(f_args$...[[1]])
